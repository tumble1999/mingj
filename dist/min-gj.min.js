var MinGJ={bin:{},home:{},mnt:{},etc:{},dev:{}};function MGJGetObj(n,o){n=n.split("/").filter(n=>""!=n);var e=[],t=o||MinGJ;for(var i of n)"."!=i&&(".."!=i?(e.push(t),t=t[i]):i=e.pop());return t}function MGJgetPrompt(){return`${MinGJ.etc.username}@${location.hostname}:${MinGJ.etc.cd}$`}function MGJWhereis(n){var o=[];for(const e of MinGJ.etc.path){MGJGetObj(e)[n]&&o.push(e+"/"+n)}return o}function MGJjoinPath(n=".",o="."){var e="/"==n[0]||"/"==o[0]?"/":"",t=[],i=n.split("/").filter(n=>""!=n),r=o.split("/").filter(n=>""!=n);function a(n){".."==n&&t.pop(),".."!=n&&"."!=n&&t.push(n)}if("/"!=o[0])for(const n of i)a(n);for(const n of r)a(n);return e+t.join("/")}function MGJcreateLogContext(n,o){var e=console.log;console.log=function(...o){e(n+":",...o)},o(),console.log=e}function MGJgetAbsolutePath(n){return"/"!=!n[0]&&(n=MGJjoinPath(MinGJ.etc.cd,n)),n}function MGJPathExist(n){n=n.split("/").filter(n=>""!=n);var o=MinGJ;for(const e of n){if(void 0===o[e])return!1;o=o[e]}return!0}function MGJuname(n){var o=[];function e(e,t,i=""){var r=n.includes("-a")||n.includes("--all");(n.includes("--"+e)||n.includes("-"+t)||r&&""!==i)&&o.push(i||"unknown")}return e("kernel-name","v","MinGJ"),e("nodename","n",location.hostname),e("kernel-release","r"),e("kernel-version","v"),e("machine","m",platform.os),e("processor","p"),e("hardware-platform","i"),e("operating-system","o",platform.name),o.join(" ")}function Bash(n){console.log(MGJgetPrompt(),n);var o=n.split(" "),e=MGJWhereis(o[0]);e.length>0?MGJcreateLogContext(o[0],(function(){MGJGetObj(e[0])(o)})):console.log("bash: "+o[0]+": command not found")}function MGJLogin(n){MinGJ.etc.username=n,MinGJ.home[n]={},console.log(`\n${location.hostname} login: ${n}`)}MinGJ.etc.path=["/bin"],MinGJ.etc.cd="/",MinGJ.etc.username="js",window.Bash=Bash,MinGJ.bin.whereis=function(n){var o=MGJWhereis(n[1]).map(o=>n[1]+":"+o);console.log(o.join("\n"))},MinGJ.bin.bash=function(n){n.length>1&&console.log("JS Bash alpha 1.0")};
MinGJ.bin.echo=function(n){n.shift(),console.log(n.join(" "))},MinGJ.bin.dir=function(n){var t=n.length>1?n[n.length-1]:".";t=MGJgetAbsolutePath(t),MGJPathExist(t)||console.log(t,"does not exist");var e=MGJGetObj(t);console.log(Object.keys(e).join(" "))},MinGJ.bin.cd=function(n){var t=n.length>1?n[n.length-1]:".";t=MGJgetAbsolutePath(t),MinGJ.etc.cd=t},MinGJ.bin.help=function(n){MinGJ.etc.path.forEach(n=>MinGJ.bin.dir(["dir",n]))},MinGJ.bin.mount=function(n){if(n.length<3)console.log("Usage: mount DEVICE PLACE");else{var t=MGJgetAbsolutePath(n[1]),e=MGJgetAbsolutePath(n[2]),i=MGJjoinPath(e,".."),o=e.split("/").pop();MGJGetObj(i)[o]=MGJGetObj(t)}},MinGJ.bin.debug=function(){console.info(MinGJ)},MinGJ.bin.exit=function(){console.log("This command has been disabled.")},MinGJ.bin.wget=function(n){var t=n[1],e=MGJGetObj(MGJgetAbsolutePath(".")),i=t.split("/");e[i[i.length-1]]=WEBAPIhttpGet(t)},MinGJ.bin.uname=function(n){console.log(MGJuname(n))},MinGJ.bin.su=function(n){n.length<2&&(MinGJ.etc.username="root"),MinGJ.etc.username=n[1]};
/*!
 * Platform.js
