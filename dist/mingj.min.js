...
const fs={bin:{init:function(n,e,t){t.write("/dev/stdout","OK.")}},home:new Object,mnt:new Object,etc:{hostname:"MinGJ"},dev:new Object};var MinGJ=new kernel(fs);function MGJgetPrompt(){return`${MinGJ.env.username}@${location.hostname}:${MinGJ.env.cd}$ `}function MGJWhereis(n){var e=[];for(const t of MinGJ.env.path){MinGJ.getObj(t)[n]&&e.push(`${t}/${n}`)}return e}function MGJcreateLogContext(n,e){var t=fs.dev.stdout.write;fs.dev.stdout.write=function(...e){t(n+":",...e)},e(),fs.dev.stdout.write=t}function MGJuname(n,e,t){var o=[];function i(n,t,i=""){var s=e.includes("-a")||e.includes("--all");(e.includes("--"+n)||e.includes("-"+t)||s&&""!==i)&&o.push(i||"unknown")}return i("kernel-name","v","MinGJ"),i("nodename","n",location.hostname),i("kernel-release","r"),i("kernel-version","v"),i("machine","m",platform.os),i("processor","p"),i("hardware-platform","i"),i("operating-system","o",platform.name),o.join(" ")}function Bash(n){MinGJ.print(MGJgetPrompt(),n);var e=n.split(" "),t=MGJWhereis(e[0]);t.length>0?MGJcreateLogContext(e[0],(function(){e.shift(),MinGJ.exec(t[0],e)})):console.log(`bash: ${e[0]}: command not found`)}function MGJLogin(n){MinGJ.env.username=n,"object"!=typeof MinGJ.home[n]&&(MinGJ.home[n]={}),console.log(`\n${location.hostname} login: ${n}`)}MinGJ.env.username="js",window.Bash=Bash,fs.bin.whereis=function(n,e,t){var o=MGJWhereis(e[1]).map(n=>`${e[1]}:${n}`);t.print(o.join("\n"))},fs.bin.bash=function(n,e,t){e.length>1&&t.print("JS Bash alpha 1.0")};
fs.bin.echo=function(n,t,e){t.shift(),e.print(t.join(" "))},fs.bin.dir=function(n,t,e){var i=n>1?t[n-1]:".";i=e.getAbsolutePath(i),e.pathExist(i)||e.print(i+" does not exist");var o=e.getObj(i);e.print(Object.keys(o).join(" "))},fs.bin.cd=function(n,t,e){var i=n>1?t[n-1]:".";i=e.getAbsolutePath(i),e.env.cd=i},fs.bin.help=function(n,t,e){MinGJ.env.path.forEach(n=>e.exec("/bin/dir",[n]))},fs.bin.mount=function(n,t,e){n<3?e.print("Usage: mount DEVICE PLACE"):e.mount(t[1],t[2])},fs.bin.debug=function(n,t,e){e.print(e)},fs.bin.exit=function(n,t,e){e.print("This command has been disabled.")},fs.bin.wget=function(n,t,e){var i=t[1],o=e.getObj(e.getAbsolutePath(".")),s=i.split("/");o[s[s.length-1]]=WEBAPIhttpGet(i)},fs.bin.uname=function(n,t,e){e.print(MGJuname(n,t,e))},fs.bin.su=function(n,t,e){if(n<2)e.env.username="root";else{var i=t[n-1];"-s"==i&&(i="root"),e.env.username=i}t.includes("-s")&&("root"==e.env.username?(fs.root=fs.root||new Object,fs.env.cd="/root"):(fs.home[e.env.username]=fs.home[e.env.username]||new Object,e.env.cd="/home/"+e.env.username))},fs.bin.cat=function(n,t,e){var i=new String,o=new String,s=0;return t.shift(),t.forEach((function(n){return e.pathExist(e.getAbsolutePath(n))?"string"==typeof(o=e.getObj(e.getAbsolutePath(n)))||o instanceof String?void(i+=o):(s=-1,e.write("/dev/stderr",`Error: ${e.getAbsolutePath(n)} is not a normal file.`)):(s=-1,e.write("/dev/stderr",`Error: ${e.getAbsolutePath(n)} does not exist.`))})),0!=s?s:e.print(i)};
/*!
 * Platform.js
