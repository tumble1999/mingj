class device{constructor(t,e){this.write=e||function(t){},this.read=t||function(){}}}class kernel{constructor(t){var e=this,s=new Array,n=65;for(s.push(32);n<=90;)s.push(n),n++;for(n=160;n<=165;)s.push(n),n++;for(n=169;n<=173;)s.push(n),n++;for(n=186;n<=193;)s.push(n),n++;for(n=219;n<=223;)s.push(n),n++;s.push(231),this.fs=t,this.env={cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.fs.dev.stdout=new device(null,console.log),this.fs.dev.stderr=new device(null,console.error),window.document.body.addEventListener("keyup",(function(t){"Backspace"==t.key&&e.buffer.length>0?e.buffer=e.buffer.substring(0,e.buffer.length-1):"Enter"==t.key?e.buffer+="\n":s.includes(t.keyCode)&&(e.buffer+=t.key)})),this.fs.dev.stdin=new device((function(){return new Promise((function t(s){var n=new String;"\n"==e.buffer[e.buffer.length-1]?(n=e.buffer,e.buffer=new String,s(n)):setTimeout((function(){t(s)}),400)}))}),null),this.exec("/bin/init")}mount(t,e){var s=this.getAbsolutePath(e),n=this.basename(s);s=this.joinPath(s,".."),this.getObj(s)[n]=t}umount(t){var e=this.getAbsolutePath(t),s=this.basename(e);e=this.joinPath(e,".."),delete this.getObj(e)[s]}getObj(t,e){var s=t.split("/").filter(t=>""!=t),n=[],i=e||this.fs;for(var r of s)"."!=r&&(".."!=r?(n.push(i),i=i[r]):r=n.pop());return i}getAbsolutePath(t){return"/"!=!t[0]&&(t=this.joinPath(this.env.cd,t)),t}joinPath(t=".",e="."){var s="/"==t[0]||"/"==e[0]?"/":"",n=[],i=t.split("/").filter(t=>""!=t),r=e.split("/").filter(t=>""!=t);function o(t){".."==t&&n.pop(),".."!=t&&"."!=t&&n.push(t)}if("/"!=e[0])for(const t of i)o(t);for(const t of r)o(t);return s+n.join("/")}pathExist(t){var e=t.split("/").filter(t=>""!=t),s=this.fs;for(const t of e){if(void 0===s[t])return!1;s=s[t]}return!0}exec(t,e){var s=this.getObj(t),n=new Array,i=new Object,r=new Object,o=-1;return e instanceof Array||(e=n),e.splice(0,0,t),s instanceof Function&&(Object.assign(i,this.fs.dev.stdout),Object.assign(r,this.fs.dev.stderr),o=3==s.length?s(e.length,e,this):2==s.length?s(e.length,e):s(),Object.assign(this.fs.dev.stdout,i),Object.assign(this.fs.dev.stderr,r)),o}basename(t){return t.split("/").pop()}write(t,e){var s=this.getObj(this.joinPath(t,"..")),n=this.basename(t),i=s[n];"string"==typeof i||i instanceof String?s[n]+=e:i instanceof device?i.write(e):void 0===i&&(s[n]=e)}read(t){var e=this.getObj(t);return e instanceof device?e.read():e}print(...t){var e=new String;return t.forEach((function(t){e+=t})),this.write("/dev/stdout",e)}}
const fs={bin:{init:function(n,e,t){t.write("/dev/stdout","OK.")}},home:new Object,mnt:new Object,etc:{hostname:"MinGJ"},dev:new Object};var MinGJ=new kernel(fs);function MGJgetPrompt(){return`${MinGJ.env.username}@${location.hostname}:${MinGJ.env.cd}$ `}function MGJWhereis(n){var e=[];for(const t of MinGJ.env.path){MinGJ.getObj(t)[n]&&e.push(`${t}/${n}`)}return e}function MGJcreateLogContext(n,e){var t=fs.dev.stdout.write;fs.dev.stdout.write=function(...e){t(n+":",...e)},e(),fs.dev.stdout.write=t}function MGJuname(n,e,t){var o=[];function i(n,e,t=""){var i=args.includes("-a")||args.includes("--all");(args.includes("--"+n)||args.includes("-"+e)||i&&""!==t)&&o.push(t||"unknown")}return i("kernel-name","v",t.env.hostname),i("nodename","n",location.hostname),i("kernel-release","r"),i("kernel-version","v"),i("machine","m",platform.os),i("processor","p"),i("hardware-platform","i"),i("operating-system","o",platform.name),o.join(" ")}function Bash(n){MinGJ.print(MGJgetPrompt(),n);var e=n.split(" "),t=MGJWhereis(e[0]);t.length>0?MGJcreateLogContext(e[0],(function(){e.shift(),MinGJ.exec(t[0],e)})):console.log(`bash: ${e[0]}: command not found`)}function MGJLogin(n){MinGJ.env.username=n,"object"!=typeof MinGJ.home[n]&&(MinGJ.home[n]={}),console.log(`\n${location.hostname} login: ${n}`)}MinGJ.env.username="js",window.Bash=Bash,fs.bin.whereis=function(n,e,t){var o=MGJWhereis(e[1]).map(n=>`${e[1]}:${n}`);t.print(o.join("\n"))},fs.bin.bash=function(n,e,t){args.length>1&&t.print("JS Bash alpha 1.0")};
fs.bin.echo=function(t,n,e){n.shift(),e.print(n.join(" "))},fs.bin.dir=function(t,n,e){var i=t>1?n[t-1]:".";i=e.getAbsolutePath(i),e.pathExist(i)||e.print(i+" does not exist");var o=e.getObj(i);e.print(Object.keys(o).join(" "))},fs.bin.cd=function(t,n,e){var i=t>1?n[t-1]:".";i=e.getAbsolutePath(i),e.env.cd=i},fs.bin.help=function(t,n,e){MinGJ.env.path.forEach(t=>e.exec("/bin/dir",[t]))},fs.bin.mount=function(t,n,e){t<3?e.print("Usage: mount DEVICE PLACE"):mount(n[1],n[2])},fs.bin.debug=function(t,n,e){e.print(e)},fs.bin.exit=function(t,n,e){e.print("This command has been disabled.")},fs.bin.wget=function(t,n,e){var i=n[1],o=e.getObj(e.getAbsolutePath(".")),s=i.split("/");o[s[s.length-1]]=WEBAPIhttpGet(i)},fs.bin.uname=function(t,n,e){e.write(MGJuname(t,n,e))},fs.bin.su=function(t,n,e){if(t<2)e.env.username="root";else{var i=n[t-1];"-s"==i&&(i="root"),e.env.username=i}n.includes("-s")&&("root"==e.env.username?(fs.root=fs.root||new Object,fs.env.cd="/root"):(fs.home[e.env.username]=fs.home[e.env.username]||new Object,e.env.cd="/home/"+e.env.username))},fs.bin.cat=function(t,n,e){var i=new String,o=new String,s=0;return n.shift(),n.forEach((function(t){return e.pathExist(e.getAbsolutePath(t))?"string"==typeof(o=e.getObj(e.getAbsolutePath(t)))||o instanceof String?void(i+=o):(s=-1,e.write("/dev/stderr",`Error: ${e.getAbsolutePath(t)} is not a normal file.`)):(s=-1,e.write("/dev/stderr",`Error: ${e.getAbsolutePath(t)} does not exist.`))})),0!=s?s:e.print(i)};
/*!
 * Platform.js
