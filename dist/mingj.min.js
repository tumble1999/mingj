...
class kernel{constructor(e){var t=this,n=new Array,s=65;for(n.push(32);s<=90;)n.push(s),s++;for(s=160;s<=165;)n.push(s),s++;for(s=169;s<=173;)n.push(s),s++;for(s=186;s<=193;)n.push(s),s++;for(s=219;s<=223;)n.push(s),s++;n.push(231),this.fs=e,this.env={shell:"/bin/bash",cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.fs.dev.stdout=new device(null,console.log),this.fs.dev.stderr=new device(null,console.error),window.document.body.addEventListener("keyup",(function(e){"Backspace"==e.key&&t.buffer.length>0?t.buffer=t.buffer.substring(0,t.buffer.length-1):"Enter"==e.key?t.buffer+="\n":n.includes(e.keyCode)&&(t.buffer+=e.key)})),this.fs.dev.stdin=new device((function(){return new Promise((function e(n){var s=new String;"\n"==t.buffer[t.buffer.length-1]?(s=t.buffer,t.buffer=new String,n(s)):setTimeout((function(){e(n)}),400)}))}),null),this.exec("/bin/init")}open(e,t){var n=e.split("/").filter(e=>""!=e),s=[],i=t||this.fs;for(var r of n)"."!=r&&(".."!=r?(s.push(i),i=i[r]):r=s.pop());return i}realpath(e){var t=new Array,n=e.split("/").filter(e=>""!==e&&"."!==e);for(var s of n)".."==s?t.pop():t.push(s);return("/"==e[0]?"/":"")+t.join("/")}getAbsolutePath(e){return console.warn("sys.getAbsolutePath has been depracated for the more acurate sys.realpath"),"/"!=!e[0]&&(e=this.realpath(this.env.cd+"/"+e)),this.realpath(e)}joinPath(e=".",t="."){return console.warn("sys.joinPath has been depracated for the more acurate sys.realpath"),this.realpath(e+"/"+t)}pathExist(e){var t=e.split("/").filter(e=>""!=e),n=this.fs;for(const e of t){if(void 0===n[e])return!1;n=n[e]}return!0}exec(e,t){var n=this.open(e),s=new Array,i=new Object,r=new Object,o=-1;return t instanceof Array||(t=s),t.splice(0,0,e),n instanceof Function&&(Object.assign(i,this.fs.dev.stdout),Object.assign(r,this.fs.dev.stderr),o=3==n.length?n(t.length,t,this):2==n.length?n(t.length,t):n(),Object.assign(this.fs.dev.stdout,i),Object.assign(this.fs.dev.stderr,r)),o}parentPath(e){return this.joinPath(e,"..")}basename(e){return e.split("/").pop()}write(e,t){var n=this.open(this.joinPath(e,"..")),s=this.basename(e),i=n[s];"string"==typeof i||i instanceof String?n[s]+=t:i instanceof device?i.write(t):void 0===i&&(n[s]=t)}read(e){var t=this.open(e);return t instanceof device?t.read():t}mount(e,t){var n=this.getAbsolutePath(t),s=this.basename(n);n=this.joinPath(n,"..");var i=this.open(i);i instanceof blockDevice?this.print("mount: "+e+": Block device mounting coming Soon"):("object"!=typeof i&&this.print("mount: "+e+": is not a mountable node."),this.open(n)[s]=i)}umount(e){var t=this.getAbsolutePath(e),n=this.basename(t);t=this.joinPath(t,".."),delete this.open(t)[n]}print(...e){var t=new String;return e.forEach((function(e){t+=e})),this.write("/dev/stdout",t)}gendevname(e){for(var t=e.constructor.name,n=1;this.fs.dev[t+n]!=e&&this.fs.dev[t+n];)n++;t+=n}mknod(e,t,n,s){["b","c"].includes(t)||this.print("mknod: "+t+": invalid device type");var i,r=this.open(this.joinPath(e,"..")),o=this.basename(e);"b"==t&&(i=new blockDevice),"c"==t&&(i=null),r[o]=i}mkdir(e,t){if(!this.pathExist(e)){var n=this.parentPath(e);this.pathExist(n)||this.mkdir(n),this.write(e,new Folder)}}}
//! /lib
