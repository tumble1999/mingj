...
class kernel{constructor(t){var e=this,i=new Array,n=65;for(i.push(32);n<=90;)i.push(n),n++;for(n=160;n<=165;)i.push(n),n++;for(n=169;n<=173;)i.push(n),n++;for(n=186;n<=193;)i.push(n),n++;for(n=219;n<=223;)i.push(n),n++;i.push(231),this.fs=t,this.env={shell:"/bin/bash",cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.write("/dev/stdout",new device(null,console.log)),this.write("/dev/stderr",new device(null,console.error)),window.document.body.addEventListener("keyup",(function(t){"Backspace"==t.key&&e.buffer.length>0?e.buffer=e.buffer.substring(0,e.buffer.length-1):"Enter"==t.key?e.buffer+="\n":i.includes(t.keyCode)&&(e.buffer+=t.key)})),this.write("/dev/stdin",new device((function(){return new Promise((function t(i){var n=new String;"\n"==e.buffer[e.buffer.length-1]?(n=e.buffer,e.buffer=new String,i(n)):setTimeout((function(){t(i)}),400)}))}),null)),this.exec("/bin/init")}getObj(t,e){var i=t.split("/").filter(t=>""!=t),n=[],s=e||this.fs;for(var r of i)"."!=r&&(".."!=r?(n.push(s),s=s[r]):r=n.pop());return s}getAbsolutePath(t){return"/"!=!t[0]&&(t=this.joinPath(this.env.cd,t)),t}joinPath(t=".",e="."){var i="/"==t[0]||"/"==e[0]?"/":"",n=[],s=t.split("/").filter(t=>""!=t),r=e.split("/").filter(t=>""!=t);function o(t){".."==t&&n.pop(),".."!=t&&"."!=t&&n.push(t)}if("/"!=e[0])for(const t of s)o(t);for(const t of r)o(t);return i+n.join("/")}pathExist(t){var e=t.split("/").filter(t=>""!=t),i=this.fs;for(const t of e){if(void 0===i[t])return!1;i=i[t]}return!0}exec(t,e){var i=this.getObj(t),n=new Array,s=new Object,r=new Object,o=-1;return e instanceof Array||(e=n),e.splice(0,0,t),i instanceof Function&&(Object.assign(s,this.fs.dev.stdout),Object.assign(r,this.fs.dev.stderr),o=3==i.length?i(e.length,e,this):2==i.length?i(e.length,e):i(),Object.assign(this.fs.dev.stdout,s),Object.assign(this.fs.dev.stderr,r)),o}get_parent(t){return this.joinPath(t,"..")}basename(t){return t.split("/").pop()}write(t,e){var i=this.getObj(this.get_parent(t)),n=this.basename(t),s=i[n];"string"==typeof s||s instanceof String?i[n]+=e:s instanceof device?s.write(e):void 0===s&&(i[n]=e)}delete(t){delete this.getObj(this.get_parent(t))[this.basename(t)]}read(t){var e=this.getObj(t);return e instanceof device?e.read():e}mount(t,e){var i=this.getObj(i);i instanceof blockDevice?this.print("mount: "+t+": Block device mounting coming Soon"):("object"!=typeof i&&this.print("mount: "+t+": is not a mountable node."),this.write(e,i))}umount(t){this.delete(this.getAbsolutePath(t))}print(...t){var e=new String;return t.forEach((function(t){e+=t})),this.write("/dev/stdout",e)}gendevname(t){for(var e=t.constructor.name,i=1;this.fs.dev[e+i]!=t&&this.fs.dev[e+i];)i++;e+=i}mknod(t,e,i,n){if(["b","c"].includes(e)||this.print("mknod: "+e+": invalid device type"),this.pathExist(t))return 1;"b"==e&&(dev=this.write(t,new blockDevice)),"c"==e&&(dev=this.write(t,new charDevice))}mkdir(t,e){if(!this.pathExist(t)){var i=this.get_parent(t);this.pathExist(i)||this.mkdir(i),this.write(t,new Folder)}}}
const fs={bin:new Folder({init:function(e,n,o){o.write("/dev/stdout","OK.")}}),home:new Folder,mnt:new Folder,etc:new Folder({hostname:"MinGJ"}),dev:new Folder};var MinGJ=new kernel(fs),shell=e=>{MinGJ.print(MGJgetPrompt(),e);var n=e.split(" ");MGJWhereis(n[0]).length>0?n.shift():console.log(`bash: ${n[0]}: command not found`)};MinGJ.env.username="js";
//! /lib
