...
class charDevice extends device{constructor(r){super((function(r=0){return this.array[r]}),(function(r,t=0){this.array[t]=new String(r).charCodeAt(0)})),this.array=Uint8Array.from(r,(function(r){return r.charCodeAt(0)}))}readArray(r=0,t=1){return this.array.subarray(r,r+t)}writeArray(r,t=0){for(let a=t;a<t+r.length;a++)this.write(r,a)}}
class Folder{constructor(s){Object.assign(this,s)}}
class kernel{constructor(e){var t=this,n=new Array,r=65;for(n.push(32);r<=90;)n.push(r),r++;for(r=160;r<=165;)n.push(r),r++;for(r=169;r<=173;)n.push(r),r++;for(r=186;r<=193;)n.push(r),r++;for(r=219;r<=223;)n.push(r),r++;n.push(231),this.fs=e,this.env={shell:"/bin/bash",cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.fs.dev.stdout=new device(null,console.log),this.fs.dev.stderr=new device(null,console.error),window.document.body.addEventListener("keyup",(function(e){"Backspace"==e.key&&t.buffer.length>0?t.buffer=t.buffer.substring(0,t.buffer.length-1):"Enter"==e.key?t.buffer+="\n":n.includes(e.keyCode)&&(t.buffer+=e.key)})),this.fs.dev.stdin=new device((function(){return new Promise((function e(n){var r=new String;"\n"==t.buffer[t.buffer.length-1]?(r=t.buffer,t.buffer=new String,n(r)):setTimeout((function(){e(n)}),400)}))}),null),this.exec("/bin/init")}open(e,t){var n=e.split("/").filter(e=>""!=e),r=[],s=t||this.fs;for(var i of n)"."!=i&&(".."!=i?(r.push(s),s=s[i]):i=r.pop());return s}realpath(...e){e=e.join("/");var t=new Array,n=e.split("/").filter(e=>""!==e&&"."!==e);for(var r of n)".."==r?t.pop():t.push(r);return("/"==e[0]?"/":"")+t.join("/")}getAbsolutePath(e){return console.info("please can someone find the  name for a syscall that adds path to cd"),this.realpath(("/"==e[0]?"":this.env.cd+"/")+e)}joinPath(e=".",t="."){return console.warn("sys.joinPath has been depracated for the more acurate sys.realpath"),this.realpath(e+"/"+t)}pathExist(e){var t=e.split("/").filter(e=>""!=e),n=this.fs;for(const e of t){if(void 0===n[e])return!1;n=n[e]}return!0}exec(e,t){var n=this.open(e),r=new Array,s=new Object,i=new Object,o=-1;return t instanceof Array||(t=r),t.splice(0,0,e),n instanceof Function&&(Object.assign(s,this.fs.dev.stdout),Object.assign(i,this.fs.dev.stderr),o=3==n.length?n(t.length,t,this):2==n.length?n(t.length,t):n(),Object.assign(this.fs.dev.stdout,s),Object.assign(this.fs.dev.stderr,i)),o}parentPath(e){return this.realpath(e+"/..")}basename(e){return e.split("/").pop()}write(e,t){var n=this.open(this.realpath(e+"/..")),r=this.basename(e),s=n[r];"string"==typeof s||s instanceof String?n[r]+=t:s instanceof device?s.write(t):void 0===s&&(n[r]=t)}read(e){var t=this.open(e);return t instanceof device?t.read():t}mount(e,t){var n=this.open(n);n instanceof blockDevice?this.print("mount: "+e+": Block device mounting coming Soon"):"object"==typeof n?this.write(t,n):this.print("mount: "+e+": is not a mountable node.")}umount(e){var t=this.getAbsolutePath(e),n=this.basename(t);t=this.realpath(t+"/.."),delete this.open(t)[n]}print(...e){var t=new String;return e.forEach((function(e){t+=e})),this.write("/dev/stdout",t)}gendevname(e){for(var t=e.constructor.name,n=1;this.fs.dev[t+n]!=e&&this.fs.dev[t+n];)n++;t+=n}mknod(e,t,n,r){["b","c"].includes(t)||this.print("mknod: "+t+": invalid device type"),"b"==t&&this.write(e,new blockDevice),"c"==t&&this.write(e,new charDevice)}mkdir(e,t){if(!this.pathExist(e)){var n=this.parentPath(e);this.pathExist(n)||this.mkdir(n),this.write(e,new Folder)}}uname(e){var t=[];function n(n,r,s=""){var i=e.includes("-a")||e.includes("--all");(e.includes("--"+n)||e.includes("-"+r)||i&&""!==s)&&t.push(s||"unknown")}return n("kernel-name","v","MinGJ"),n("nodename","n",location.hostname),n("kernel-release","r"),n("kernel-version","v"),n("machine","m",platform.os),n("processor","p"),n("hardware-platform","i"),n("operating-system","o",platform.name),t.join(" ")}whereis(e){var t=[];for(const n of MinGJ.env.path){MinGJ.open(n)[e]&&t.push(`${n}/${e}`)}return t}getprompt(){var e=this.env.username||"root";return`${e}@${location.hostname}:${this.env.cd}${"root"==e?"#":"$"} `}}
//! /lib
...
!function(){"use strict";var e={not_string:/[^s]/,not_bool:/[^t]/,not_type:/[^T]/,not_primitive:/[^v]/,number:/[diefg]/,numeric_arg:/[bcdiefguxX]/,json:/[j]/,not_json:/[^j]/,text:/^[^\x25]+/,modulo:/^\x25{2}/,placeholder:/^\x25(?:([1-9]\d*)\$|\(([^)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-gijostTuvxX])/,key:/^([a-z_][a-z_\d]*)/i,key_access:/^\.([a-z_][a-z_\d]*)/i,index_access:/^\[(\d+)\]/,sign:/^[+-]/};function t(r){return function(r,n){var i,s,a,o,p,c,l,u,f,d=1,g=r.length,y="";for(s=0;s<g;s++)if("string"==typeof r[s])y+=r[s];else if("object"==typeof r[s]){if((o=r[s]).keys)for(i=n[d],a=0;a<o.keys.length;a++){if(null==i)throw new Error(t('[sprintf] Cannot access property "%s" of undefined value "%s"',o.keys[a],o.keys[a-1]));i=i[o.keys[a]]}else i=o.param_no?n[o.param_no]:n[d++];if(e.not_type.test(o.type)&&e.not_primitive.test(o.type)&&i instanceof Function&&(i=i()),e.numeric_arg.test(o.type)&&"number"!=typeof i&&isNaN(i))throw new TypeError(t("[sprintf] expecting number but found %T",i));switch(e.number.test(o.type)&&(u=0<=i),o.type){case"b":i=parseInt(i,10).toString(2);break;case"c":i=String.fromCharCode(parseInt(i,10));break;case"d":case"i":i=parseInt(i,10);break;case"j":i=JSON.stringify(i,null,o.width?parseInt(o.width):0);break;case"e":i=o.precision?parseFloat(i).toExponential(o.precision):parseFloat(i).toExponential();break;case"f":i=o.precision?parseFloat(i).toFixed(o.precision):parseFloat(i);break;case"g":i=o.precision?String(Number(i.toPrecision(o.precision))):parseFloat(i);break;case"o":i=(parseInt(i,10)>>>0).toString(8);break;case"s":i=String(i),i=o.precision?i.substring(0,o.precision):i;break;case"t":i=String(!!i),i=o.precision?i.substring(0,o.precision):i;break;case"T":i=Object.prototype.toString.call(i).slice(8,-1).toLowerCase(),i=o.precision?i.substring(0,o.precision):i;break;case"u":i=parseInt(i,10)>>>0;break;case"v":i=i.valueOf(),i=o.precision?i.substring(0,o.precision):i;break;case"x":i=(parseInt(i,10)>>>0).toString(16);break;case"X":i=(parseInt(i,10)>>>0).toString(16).toUpperCase()}e.json.test(o.type)?y+=i:(!e.number.test(o.type)||u&&!o.sign?f="":(f=u?"+":"-",i=i.toString().replace(e.sign,"")),c=o.pad_char?"0"===o.pad_char?"0":o.pad_char.charAt(1):" ",l=o.width-(f+i).length,p=o.width&&0<l?c.repeat(l):"",y+=o.align?f+i+p:"0"===c?f+p+i:p+f+i)}return y}(function(t){if(n[t])return n[t];for(var r,i=t,s=[],a=0;i;){if(null!==(r=e.text.exec(i)))s.push(r[0]);else if(null!==(r=e.modulo.exec(i)))s.push("%");else{if(null===(r=e.placeholder.exec(i)))throw new SyntaxError("[sprintf] unexpected placeholder");if(r[2]){a|=1;var o=[],p=r[2],c=[];if(null===(c=e.key.exec(p)))throw new SyntaxError("[sprintf] failed to parse named argument key");for(o.push(c[1]);""!==(p=p.substring(c[0].length));)if(null!==(c=e.key_access.exec(p)))o.push(c[1]);else{if(null===(c=e.index_access.exec(p)))throw new SyntaxError("[sprintf] failed to parse named argument key");o.push(c[1])}r[2]=o}else a|=2;if(3===a)throw new Error("[sprintf] mixing positional and named placeholders is not (yet) supported");s.push({placeholder:r[0],param_no:r[1],keys:r[2],sign:r[3],pad_char:r[4],align:r[5],width:r[6],precision:r[7],type:r[8]})}i=i.substring(r[0].length)}return n[t]=s}(r),arguments)}function r(e,r){return t.apply(null,[e].concat(r||[]))}var n=Object.create(null);"undefined"!=typeof exports&&(exports.sprintf=t,exports.vsprintf=r),"undefined"!=typeof window&&(window.sprintf=t,window.vsprintf=r,"function"==typeof define&&define.amd&&define((function(){return{sprintf:t,vsprintf:r}})))}();
function WEBAPIhttpGet(e){var t=new XMLHttpRequest;return t.open("GET",e,!1),t.send(null),t.responseText}
//! /bin

function MGJgetPrompt(){return console.warn("MGJgetPrompt() has deprecated in favor of sys.getprompt()"),MinGJ.getprompt()}function MGJWhereis(n){return console.warn("MGJWhereis(name) has deprecated in favor of sys.whereis(name)"),MinGJ.whereis(n)}function MGJuname(n,e,o){return console.warn("MGJUname(argc, argv, sys) has deprecated in favor of sys.uname(argv)"),o.uname(e)}function Bash(n){MinGJ.print(MGJgetPrompt(),n);var e=n.split(" "),o=MGJWhereis(e[0]);o.length>0?(e.shift(),MinGJ.exec(o[0],e)):console.log(`bash: ${e[0]}: command not found`)}function MGJLogin(n){MinGJ.exec("/bin/su",["-s",n]),MinGJ.print(`\n${location.hostname} login: ${n}`)}window.Bash=Bash,fs.bin.bash=function(n,e,o){e.length>1&&o.print("JS Bash alpha 1.0")};
...
fs.bin.dir=function(t,e,i){var n=t>1?e[t-1]:".";n=i.getAbsolutePath(n),i.pathExist(n)||i.printerr(`${e[0]}: ${n}: does not exist`);var r=i.open(n);i.print(Object.keys(r).join(" "))};
...
fs.bin.mkdir=function(i,t,f){t.shift(),t.forEach(i=>{i=f.getAbsolutePath(i),f.mkdir(i)})};
...
fs.bin.su=function(e,n,o){if(e<2)o.env.username="root";else{var s=n[e-1];"-s"==s&&(s="root"),o.env.username=s}n.includes("-s")&&("root"==o.env.username?(fs.root=fs.root||new Folder,o.env.cd="/root"):(fs.home[o.env.username]=fs.home[o.env.username]||new Folder,o.env.cd="/home/"+o.env.username))};
fs.bin.uname=function(n,i,u){u.print(MGJuname(n,i,u))};
fs.bin.wget=function(t,e,n){var g=e[1],h=n.open(n.getAbsolutePath(".")),i=g.split("/");h[i[i.length-1]]=WEBAPIhttpGet(g)};
