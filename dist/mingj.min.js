...
const fs=new Folder({bin:new Folder({init:function(e,n,o){o.write("/dev/stdout","OK.")}}),home:new Folder,mnt:new Folder,etc:new Folder({hostname:"MinGJ"}),dev:new Folder});var MinGJ=new kernel(fs);MinGJ.exec("/bin/su",["js"]);
//! /lib
