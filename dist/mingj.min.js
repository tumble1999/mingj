...
<<<<<<< HEAD
<<<<<<< HEAD
class kernel{constructor(t){var e=this,i=new Array,s=65;for(i.push(32);s<=90;)i.push(s),s++;for(s=160;s<=165;)i.push(s),s++;for(s=169;s<=173;)i.push(s),s++;for(s=186;s<=193;)i.push(s),s++;for(s=219;s<=223;)i.push(s),s++;i.push(231),this.fs=t,this.env={shell:"/bin/bash",cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.write("/dev/stdout",new device(null,console.log)),this.write("/dev/stderr",new device(null,console.error)),window.document.body.addEventListener("keyup",(function(t){"Backspace"==t.key&&e.buffer.length>0?e.buffer=e.buffer.substring(0,e.buffer.length-1):"Enter"==t.key?e.buffer+="\n":i.includes(t.keyCode)&&(e.buffer+=t.key)})),this.write("/dev/stdin",new device((function(){return new Promise((function t(i){var s=new String;"\n"==e.buffer[e.buffer.length-1]?(s=e.buffer,e.buffer=new String,i(s)):setTimeout((function(){t(i)}),400)}))}),null)),this.exec("/bin/init")}getObj(t,e){var i=t.split("/").filter(t=>""!=t),s=[],n=e||this.fs;for(var r of i)"."!=r&&(".."!=r?(s.push(n),n=n[r]):r=s.pop());return n}getAbsolutePath(t){return"/"!=!t[0]&&(t=this.joinPath(this.env.cd,t)),t}joinPath(t=".",e="."){var i="/"==t[0]||"/"==e[0]?"/":"",s=[],n=t.split("/").filter(t=>""!=t),r=e.split("/").filter(t=>""!=t);function o(t){".."==t&&s.pop(),".."!=t&&"."!=t&&s.push(t)}if("/"!=e[0])for(const t of n)o(t);for(const t of r)o(t);return i+s.join("/")}pathExist(t){var e=t.split("/").filter(t=>""!=t),i=this.fs;for(const t of e){if(void 0===i[t])return!1;i=i[t]}return!0}exec(t,e){var i=this.getObj(t),s=new Array,n=new Object,r=new Object,o=-1;return e instanceof Array||(e=s),e.splice(0,0,t),i instanceof Function&&(Object.assign(n,this.fs.dev.stdout),Object.assign(r,this.fs.dev.stderr),o=3==i.length?i(e.length,e,this):2==i.length?i(e.length,e):i(),Object.assign(this.fs.dev.stdout,n),Object.assign(this.fs.dev.stderr,r)),o}get_parent(t){return this.joinPath(t,"..")}basename(t){return t.split("/").pop()}write(t,e){var i=this.getObj(this.get_parent(t)),s=this.basename(t),n=i[s];"string"==typeof n||n instanceof String?i[s]+=e:n instanceof device?n.write(e):void 0===n&&(i[s]=e)}delete(t){delete this.getObj(this.get_parent(t))[this.basename(t)]}read(t){var e=this.getObj(t);return e instanceof device?e.read():e}mount(t,e){var i=this.getObj(i);i instanceof blockDevice?this.print("mount: "+t+": Block device mounting coming Soon"):("object"!=typeof i&&this.print("mount: "+t+": is not a mountable node."),this.write(e,i))}umount(t){this.delete(this.getAbsolutePath(t))}printk(t,...e){var i=sprintf(...e);switch(t){case 0:case 1:case 2:case 3:case 4:return this.write("/dev/stderr",i);case 5:case 6:case 7:default:return this.write("/dev/stdout",i)}}printerr(...t){this.printk(3,...t)}print(...t){this.printk(null,...t)}gendevname(t){for(var e=t.constructor.name,i=1;this.fs.dev[e+i]!=t&&this.fs.dev[e+i];)i++;e+=i}mknod(t,e,i,s){if(["b","c"].includes(e)||this.print("mknod: "+e+": invalid device type"),this.pathExist(t))return 1;"b"==e&&(dev=this.write(t,new blockDevice)),"c"==e&&(dev=this.write(t,new charDevice))}mkdir(t,e){if(!this.pathExist(t)){var i=this.get_parent(t);this.pathExist(i)||this.mkdir(i),this.write(t,new Folder)}}}
const fs={bin:new Folder({init:function(n,e,t){t.write("/dev/stdout","OK.")}}),etc:new Folder({hostname:"MinGJ"}),dev:new Folder};var MinGJ=new kernel(fs),shell=n=>{MinGJ.print(MGJgetPrompt(),n);var e=n.split(" ");MGJWhereis(e[0]).length>0?e.shift():MinGJ.printerr(`bash: ${e[0]}: command not found`)};MinGJ.env.username="js";
=======
class kernel{constructor(t){var e=this,n=new Array,i=65;for(n.push(32);i<=90;)n.push(i),i++;for(i=160;i<=165;)n.push(i),i++;for(i=169;i<=173;)n.push(i),i++;for(i=186;i<=193;)n.push(i),i++;for(i=219;i<=223;)n.push(i),i++;n.push(231),this.fs=t,this.env={cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.fs.dev.stdout=new device(null,console.log),this.fs.dev.stderr=new device(null,console.error),window.document.body.addEventListener("keyup",(function(t){"Backspace"==t.key&&e.buffer.length>0?e.buffer=e.buffer.substring(0,e.buffer.length-1):"Enter"==t.key?e.buffer+="\n":n.includes(t.keyCode)&&(e.buffer+=t.key)})),this.fs.dev.stdin=new device((function(){return new Promise((function t(n){var i=new String;"\n"==e.buffer[e.buffer.length-1]?(i=e.buffer,e.buffer=new String,n(i)):setTimeout((function(){t(n)}),400)}))}),null),this.exec("/bin/init")}mount(t,e){var n=this.getAbsolutePath(e),i=this.basename(n);n=this.joinPath(n,"..");var s=this.getObj(s);s instanceof blockDevice?this.print("mount: "+t+": Block device mounting coming Soon"):("object"!=typeof s&&this.print("mount: "+t+": is not a mountable node."),this.getObj(n)[i]=s)}umount(t){var e=this.getAbsolutePath(t),n=this.basename(e);e=this.joinPath(e,".."),delete this.getObj(e)[n]}getObj(t,e){var n=t.split("/").filter(t=>""!=t),i=[],s=e||this.fs;for(var r of n)"."!=r&&(".."!=r?(i.push(s),s=s[r]):r=i.pop());return s}getAbsolutePath(t){return"/"!=!t[0]&&(t=this.joinPath(this.env.cd,t)),t}joinPath(t=".",e="."){var n="/"==t[0]||"/"==e[0]?"/":"",i=[],s=t.split("/").filter(t=>""!=t),r=e.split("/").filter(t=>""!=t);function o(t){".."==t&&i.pop(),".."!=t&&"."!=t&&i.push(t)}if("/"!=e[0])for(const t of s)o(t);for(const t of r)o(t);return n+i.join("/")}pathExist(t){var e=t.split("/").filter(t=>""!=t),n=this.fs;for(const t of e){if(void 0===n[t])return!1;n=n[t]}return!0}exec(t,e){var n=this.getObj(t),i=new Array,s=new Object,r=new Object,o=-1;return e instanceof Array||(e=i),e.splice(0,0,t),n instanceof Function&&(Object.assign(s,this.fs.dev.stdout),Object.assign(r,this.fs.dev.stderr),o=3==n.length?n(e.length,e,this):2==n.length?n(e.length,e):n(),Object.assign(this.fs.dev.stdout,s),Object.assign(this.fs.dev.stderr,r)),o}parentPath(t){return this.joinPath(t,"..")}basename(t){return t.split("/").pop()}write(t,e){var n=this.getObj(this.joinPath(t,"..")),i=this.basename(t),s=n[i];"string"==typeof s||s instanceof String?n[i]+=e:s instanceof device?s.write(e):void 0===s&&(n[i]=e)}read(t){var e=this.getObj(t);return e instanceof device?e.read():e}print(...t){var e=new String;return t.forEach((function(t){e+=t})),this.write("/dev/stdout",e)}gendevname(t){for(var e=t.constructor.name,n=1;this.fs.dev[e+n]!=t&&this.fs.dev[e+n];)n++;e+=n}mknod(t,e,n,i){["b","c"].includes(e)||this.print("mknod: "+e+": invalid device type");var s,r=this.getObj(this.joinPath(t,"..")),o=this.basename(t);"b"==e&&(s=new blockDevice),"c"==e&&(s=null),r[o]=s}mkdir(t,e){if(!this.pathExist(t)){var n=this.parentPath(t);this.pathExist(n)||this.mkdir(n),this.write(t,new Folder)}}}
>>>>>>> parent of 7aecb3a... hmm
=======
class kernel{constructor(t){var e=this,n=new Array,i=65;for(n.push(32);i<=90;)n.push(i),i++;for(i=160;i<=165;)n.push(i),i++;for(i=169;i<=173;)n.push(i),i++;for(i=186;i<=193;)n.push(i),i++;for(i=219;i<=223;)n.push(i),i++;n.push(231),this.fs=t,this.env={cd:"/",path:["/bin"],hostname:this.fs.etc.hostname},this.buffer=new String,this.fs.dev.stdout=new device(null,console.log),this.fs.dev.stderr=new device(null,console.error),window.document.body.addEventListener("keyup",(function(t){"Backspace"==t.key&&e.buffer.length>0?e.buffer=e.buffer.substring(0,e.buffer.length-1):"Enter"==t.key?e.buffer+="\n":n.includes(t.keyCode)&&(e.buffer+=t.key)})),this.fs.dev.stdin=new device((function(){return new Promise((function t(n){var i=new String;"\n"==e.buffer[e.buffer.length-1]?(i=e.buffer,e.buffer=new String,n(i)):setTimeout((function(){t(n)}),400)}))}),null),this.exec("/bin/init")}mount(t,e){var n=this.getAbsolutePath(e),i=this.basename(n);n=this.joinPath(n,"..");var s=this.getObj(s);s instanceof blockDevice?this.print("mount: "+t+": Block device mounting coming Soon"):("object"!=typeof s&&this.print("mount: "+t+": is not a mountable node."),this.getObj(n)[i]=s)}umount(t){var e=this.getAbsolutePath(t),n=this.basename(e);e=this.joinPath(e,".."),delete this.getObj(e)[n]}getObj(t,e){var n=t.split("/").filter(t=>""!=t),i=[],s=e||this.fs;for(var r of n)"."!=r&&(".."!=r?(i.push(s),s=s[r]):r=i.pop());return s}getAbsolutePath(t){return"/"!=!t[0]&&(t=this.joinPath(this.env.cd,t)),t}joinPath(t=".",e="."){var n="/"==t[0]||"/"==e[0]?"/":"",i=[],s=t.split("/").filter(t=>""!=t),r=e.split("/").filter(t=>""!=t);function o(t){".."==t&&i.pop(),".."!=t&&"."!=t&&i.push(t)}if("/"!=e[0])for(const t of s)o(t);for(const t of r)o(t);return n+i.join("/")}pathExist(t){var e=t.split("/").filter(t=>""!=t),n=this.fs;for(const t of e){if(void 0===n[t])return!1;n=n[t]}return!0}exec(t,e){var n=this.getObj(t),i=new Array,s=new Object,r=new Object,o=-1;return e instanceof Array||(e=i),e.splice(0,0,t),n instanceof Function&&(Object.assign(s,this.fs.dev.stdout),Object.assign(r,this.fs.dev.stderr),o=3==n.length?n(e.length,e,this):2==n.length?n(e.length,e):n(),Object.assign(this.fs.dev.stdout,s),Object.assign(this.fs.dev.stderr,r)),o}parentPath(t){return this.joinPath(t,"..")}basename(t){return t.split("/").pop()}write(t,e){var n=this.getObj(this.joinPath(t,"..")),i=this.basename(t),s=n[i];"string"==typeof s||s instanceof String?n[i]+=e:s instanceof device?s.write(e):void 0===s&&(n[i]=e)}read(t){var e=this.getObj(t);return e instanceof device?e.read():e}print(...t){var e=new String;return t.forEach((function(t){e+=t})),this.write("/dev/stdout",e)}gendevname(t){for(var e=t.constructor.name,n=1;this.fs.dev[e+n]!=t&&this.fs.dev[e+n];)n++;e+=n}mknod(t,e,n,i){["b","c"].includes(e)||this.print("mknod: "+e+": invalid device type");var s,r=this.getObj(this.joinPath(t,"..")),o=this.basename(t);"b"==e&&(s=new blockDevice),"c"==e&&(s=null),r[o]=s}mkdir(t,e){if(!this.pathExist(t)){var n=this.parentPath(t);this.pathExist(n)||this.mkdir(n),this.write(t,new Folder)}}}
>>>>>>> parent of 7aecb3a... hmm
//! /lib
...
const fs={bin:new Folder({init:function(n,e,o){o.write("/dev/stdout","OK.")}}),home:new Folder,mnt:new Folder,etc:new Folder({hostname:"MinGJ"}),dev:new Folder};var MinGJ=new kernel(fs);function MGJgetPrompt(){return`${MinGJ.env.username}@${location.hostname}:${MinGJ.env.cd}$ `}function MGJWhereis(n){var e=[];for(const o of MinGJ.env.path){MinGJ.getObj(o)[n]&&e.push(`${o}/${n}`)}return e}function MGJuname(n,e,o){var i=[];function t(n,o,t=""){var r=e.includes("-a")||e.includes("--all");(e.includes("--"+n)||e.includes("-"+o)||r&&""!==t)&&i.push(t||"unknown")}return t("kernel-name","v","MinGJ"),t("nodename","n",location.hostname),t("kernel-release","r"),t("kernel-version","v"),t("machine","m",platform.os),t("processor","p"),t("hardware-platform","i"),t("operating-system","o",platform.name),i.join(" ")}function Bash(n){MinGJ.print(MGJgetPrompt(),n);var e=n.split(" "),o=MGJWhereis(e[0]);o.length>0?(e.shift(),MinGJ.exec(o[0],e)):console.log(`bash: ${e[0]}: command not found`)}function MGJLogin(n){MinGJ.env.username=n,"object"!=typeof MinGJ.home[n]&&(MinGJ.home[n]={}),console.log(`\n${location.hostname} login: ${n}`)}MinGJ.env.username="js",window.Bash=Bash,fs.bin.bash=function(n,e,o){e.length>1&&o.print("JS Bash alpha 1.0")};
...
fs.bin.dir=function(t,e,i){var n=t>1?e[t-1]:".";n=i.getAbsolutePath(n),i.pathExist(n)||i.printerr(`${e[0]}: ${n}: does not exist`);var r=i.getObj(n);i.print(Object.keys(r).join(" "))};
...
fs.bin.su=function(e,n,o){if(e<2)o.env.username="root";else{var s=n[e-1];"-s"==s&&(s="root"),o.env.username=s}n.includes("-s")&&("root"==o.env.username?(fs.root=fs.root||new Folder,fs.env.cd="/root"):(fs.home[o.env.username]=fs.home[o.env.username]||new Folder,o.env.cd="/home/"+o.env.username))};
